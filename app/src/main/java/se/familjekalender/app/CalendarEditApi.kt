...
private const val CALENDAR_EDIT_FUNCTION_URL =
    "https://zigychfkpgypjuovgyqq.supabase.co/functions/v1/calendar-edit"
    ...
    withContext(Dispatchers.IO) {
        val body =
            JSONObject()
                ...
                .put("eventId", eventId)
        if (memberId == null) body.put("memberId", JSONObject.NULL)
        else body.put("memberId", memberId)

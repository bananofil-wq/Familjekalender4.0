...
internal object CleanWeatherService {
            ...
            suspendCancellableCoroutine { continuation ->
                ...
                if (enabledProviders.isEmpty()) {
                    if (cached != null) {
                        ...
                        continuation.resumeWithException(
                            IllegalStateException("Platstjänster är avstängda.")
                        )
                    }
                    return@suspendCancellableCoroutine
                }
                ...
                if (!requested) {
                    if (cached != null) continuation.resume(cached)
                        ...
                        continuation.resumeWithException(
                            IllegalStateException("Kunde inte läsa aktuell plats.")
                        )
                }
    ...
    private suspend fun fetch(latitude: Double, longitude: Double): CleanWeatherSnapshot =
    ...
    private fun descriptionFor(code: Int): String =
        when (code) {
            0 -> "Klart"
            1 -> "Mestadels klart"

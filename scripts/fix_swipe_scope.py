...
s = s.replace("scope.scope.launch { monthDrag.snapTo(monthDrag.value + amount) }", "scope.launch { monthDrag.snapTo(monthDrag.value + amount) }")
...
assert "onDragEnd = {\n                      scope.launch {" in final or "onDragEnd = {\n                                scope.launch {" in final
